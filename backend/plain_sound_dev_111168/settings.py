"""
Django settings for plain_sound_dev_111168 project.
...
ROOT_URLCONF = 'plain_sound_dev_111168.urls'
...
WSGI_APPLICATION = 'plain_sound_dev_111168.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_sound_dev_111168 API",
    "DESCRIPTION": "API documentation for plain_sound_dev_111168 App",
    "VERSION": "v1",
}
